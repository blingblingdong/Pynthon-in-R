...
#Q:如何print出dictionary的key
#A:
print(list(story_dict.keys()))


def setspeed():
  speed1 = input("請選擇速度：1快板,2慢板,3google小姐版")
...
for i in story_dict['聖誕節鬼故事']:
  print(i)
  
  
for i,pargraph in enumerate(story_dict['聖誕節鬼故事']):
  text_to_speech(pargraph,f"{pargraph}{i}.mp3")
